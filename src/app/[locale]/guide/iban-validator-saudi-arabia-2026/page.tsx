...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? `\/guide/iban-validator-saudi-arabia-2026` : `\/\/guide/iban-validator-saudi-arabia-2026`,
      languages: {
        en: `\/guide/iban-validator-saudi-arabia-2026`,
        ar: `\/ar/guide/iban-validator-saudi-arabia-2026`,
        ur: `\/ur/guide/iban-validator-saudi-arabia-2026`,
        tl: `\/tl/guide/iban-validator-saudi-arabia-2026`,
        bn: `\/bn/guide/iban-validator-saudi-arabia-2026`,
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? `\/guide/iban-validator-saudi-arabia-2026` : `\/\/guide/iban-validator-saudi-arabia-2026`,
...
export default async function IbanGuidePage({ params }: Props) {
  ...
  const isBn = locale === 'bn'
  const isDefault = locale === 'en'
  const pageUrl = isDefault ? `${baseUrl}/guide/iban-validator-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/iban-validator-saudi-arabia-2026`

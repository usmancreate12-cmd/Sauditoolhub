...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? '/guide/traffic-fine-calculator-saudi-arabia-2026' : `/${locale}/guide/traffic-fine-calculator-saudi-arabia-2026`,
      languages: {
        en: '/guide/traffic-fine-calculator-saudi-arabia-2026',
        ar: '/ar/guide/traffic-fine-calculator-saudi-arabia-2026',
        ur: '/ur/guide/traffic-fine-calculator-saudi-arabia-2026',
        tl: '/tl/guide/traffic-fine-calculator-saudi-arabia-2026',
        bn: '/bn/guide/traffic-fine-calculator-saudi-arabia-2026',
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? '/guide/traffic-fine-calculator-saudi-arabia-2026' : `/${locale}/guide/traffic-fine-calculator-saudi-arabia-2026`,
...
export default async function TrafficGuidePage({ params }: Props) {
  ...
  const pageUrl = isDefault
    ? `${baseUrl}/guide/traffic-fine-calculator-saudi-arabia-2026`
    : `${baseUrl}/${locale}/guide/traffic-fine-calculator-saudi-arabia-2026`

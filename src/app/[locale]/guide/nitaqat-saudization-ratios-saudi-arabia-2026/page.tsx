...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? `${baseUrl}/guide/nitaqat-saudization-ratios-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/nitaqat-saudization-ratios-saudi-arabia-2026`,
      languages: {
        en: `${baseUrl}/guide/nitaqat-saudization-ratios-saudi-arabia-2026`,
        ar: `${baseUrl}/ar/guide/nitaqat-saudization-ratios-saudi-arabia-2026`,
        ur: `${baseUrl}/ur/guide/nitaqat-saudization-ratios-saudi-arabia-2026`,
        tl: `${baseUrl}/tl/guide/nitaqat-saudization-ratios-saudi-arabia-2026`,
        bn: `${baseUrl}/bn/guide/nitaqat-saudization-ratios-saudi-arabia-2026`,
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? `${baseUrl}/guide/nitaqat-saudization-ratios-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/nitaqat-saudization-ratios-saudi-arabia-2026`,
...
export default async function NitaqatGuidePage({ params }: Props) {
  ...
  const isBn = locale === 'bn'
  const isDefault = locale === 'en'
  const pageUrl = isDefault ? `${baseUrl}/guide/nitaqat-saudization-ratios-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/nitaqat-saudization-ratios-saudi-arabia-2026`

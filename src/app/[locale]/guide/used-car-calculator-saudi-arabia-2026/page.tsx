...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? '/guide/used-car-calculator-saudi-arabia-2026' : `/${locale}/guide/used-car-calculator-saudi-arabia-2026`,
      languages: {
        en: '/guide/used-car-calculator-saudi-arabia-2026',
        ar: '/ar/guide/used-car-calculator-saudi-arabia-2026',
        ur: '/ur/guide/used-car-calculator-saudi-arabia-2026',
        tl: '/tl/guide/used-car-calculator-saudi-arabia-2026',
        bn: '/bn/guide/used-car-calculator-saudi-arabia-2026',
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? '/guide/used-car-calculator-saudi-arabia-2026' : `/${locale}/guide/used-car-calculator-saudi-arabia-2026`,
...
export default async function CarGuidePage({ params }: Props) {
  ...
  const pageUrl = isDefault
    ? `${baseUrl}/guide/used-car-calculator-saudi-arabia-2026`
    : `${baseUrl}/${locale}/guide/used-car-calculator-saudi-arabia-2026`

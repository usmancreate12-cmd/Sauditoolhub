...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? '/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026' : `/${locale}/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026`,
      languages: {
        en: '/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026',
        ar: '/ar/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026',
        ur: '/ur/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026',
        tl: '/tl/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026',
        bn: '/bn/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026',
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? '/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026' : `/${locale}/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026`,
...
export default async function SipGuidePage({ params }: Props) {
  ...
  const pageUrl = isDefault
    ? `${baseUrl}/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026`
    : `${baseUrl}/${locale}/guide/sip-mutual-fund-investment-guide-saudi-arabia-2026`

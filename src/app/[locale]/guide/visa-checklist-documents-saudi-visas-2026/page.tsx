...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? `${baseUrl}/guide/visa-checklist-documents-saudi-visas-2026` : `${baseUrl}/${locale}/guide/visa-checklist-documents-saudi-visas-2026`,
      languages: {
        en: `${baseUrl}/guide/visa-checklist-documents-saudi-visas-2026`,
        ar: `${baseUrl}/ar/guide/visa-checklist-documents-saudi-visas-2026`,
        ur: `${baseUrl}/ur/guide/visa-checklist-documents-saudi-visas-2026`,
        tl: `${baseUrl}/tl/guide/visa-checklist-documents-saudi-visas-2026`,
        bn: `${baseUrl}/bn/guide/visa-checklist-documents-saudi-visas-2026`,
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? `${baseUrl}/guide/visa-checklist-documents-saudi-visas-2026` : `${baseUrl}/${locale}/guide/visa-checklist-documents-saudi-visas-2026`,
...
export default async function VisaChecklistGuidePage({ params }: Props) {
  ...
  const isBn = locale === 'bn'
  const isDefault = locale === 'en'
  const pageUrl = isDefault ? `${baseUrl}/guide/visa-checklist-documents-saudi-visas-2026` : `${baseUrl}/${locale}/guide/visa-checklist-documents-saudi-visas-2026`

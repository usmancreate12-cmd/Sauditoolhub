...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? `${baseUrl}/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`,
      languages: {
        en: `${baseUrl}/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`,
        ar: `${baseUrl}/ar/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`,
        ur: `${baseUrl}/ur/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`,
        tl: `${baseUrl}/tl/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`,
        bn: `${baseUrl}/bn/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`,
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? `${baseUrl}/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`,
...
export default async function ZatcaVatGuidePage({ params }: Props) {
  ...
  const isBn = locale === 'bn'
  const isDefault = locale === 'en'
  const pageUrl = isDefault ? `${baseUrl}/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/zatca-vat-einvoicing-compliance-saudi-arabia-2026`

...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? `${baseUrl}/guide/salla-profit-calculator-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/salla-profit-calculator-saudi-arabia-2026`,
      languages: {
        en: `${baseUrl}/guide/salla-profit-calculator-saudi-arabia-2026`,
        ar: `${baseUrl}/ar/guide/salla-profit-calculator-saudi-arabia-2026`,
        ur: `${baseUrl}/ur/guide/salla-profit-calculator-saudi-arabia-2026`,
        tl: `${baseUrl}/tl/guide/salla-profit-calculator-saudi-arabia-2026`,
        bn: `${baseUrl}/bn/guide/salla-profit-calculator-saudi-arabia-2026`,
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? `${baseUrl}/guide/salla-profit-calculator-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/salla-profit-calculator-saudi-arabia-2026`,
...
export default async function SallaZidProfitGuidePage({ params }: Props) {
  ...
  const isBn = locale === 'bn'
  const isDefault = locale === 'en'
  const pageUrl = isDefault ? `${baseUrl}/guide/salla-profit-calculator-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/salla-profit-calculator-saudi-arabia-2026`

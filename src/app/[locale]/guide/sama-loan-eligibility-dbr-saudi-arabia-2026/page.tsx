...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? `${baseUrl}/guide/sama-loan-eligibility-dbr-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`,
      languages: {
        en: `${baseUrl}/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`,
        ar: `${baseUrl}/ar/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`,
        ur: `${baseUrl}/ur/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`,
        tl: `${baseUrl}/tl/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`,
        bn: `${baseUrl}/bn/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`,
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? `${baseUrl}/guide/sama-loan-eligibility-dbr-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`,
...
export default async function SamaLoanGuidePage({ params }: Props) {
  ...
  const isBn = locale === 'bn'
  const isDefault = locale === 'en'
  const pageUrl = isDefault ? `${baseUrl}/guide/sama-loan-eligibility-dbr-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/sama-loan-eligibility-dbr-saudi-arabia-2026`

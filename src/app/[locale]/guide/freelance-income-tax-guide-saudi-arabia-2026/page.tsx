...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: isDefault ? `${baseUrl}/guide/freelance-income-tax-guide-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/freelance-income-tax-guide-saudi-arabia-2026`,
      languages: {
        en: `${baseUrl}/guide/freelance-income-tax-guide-saudi-arabia-2026`,
        ar: `${baseUrl}/ar/guide/freelance-income-tax-guide-saudi-arabia-2026`,
        ur: `${baseUrl}/ur/guide/freelance-income-tax-guide-saudi-arabia-2026`,
        tl: `${baseUrl}/tl/guide/freelance-income-tax-guide-saudi-arabia-2026`,
        bn: `${baseUrl}/bn/guide/freelance-income-tax-guide-saudi-arabia-2026`,
      },
    },
    openGraph: {
      title,
      description,
      url: isDefault ? `${baseUrl}/guide/freelance-income-tax-guide-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/freelance-income-tax-guide-saudi-arabia-2026`,
...
export default async function FreelanceIncomeTaxGuidePage({ params }: Props) {
  ...
  const isBn = locale === 'bn'
  const isDefault = locale === 'en'
  const pageUrl = isDefault ? `${baseUrl}/guide/freelance-income-tax-guide-saudi-arabia-2026` : `${baseUrl}/${locale}/guide/freelance-income-tax-guide-saudi-arabia-2026`
